    ...
    try {
      const requestData = {
        ...
        class_requirements: [
          ...
          {id:"A_Math_Lab",faculty:"F1",subject:"Math Lab",section:"A",class_type:"Lab",duration:2,allowed_rooms:["R3","R5"],allowed_days:[1,3,5],forbidden_periods:[7,8]},
          {id:"A_Physics_Lab",faculty:"F2",subject:"Physics Lab",section:"A",class_type:"Lab",duration:2,allowed_rooms:["R3","R5"],allowed_days:[2,4,6],forbidden_periods:[7,8]},
          {id:"A_Chemistry_Lab",faculty:"F3",subject:"Chemistry Lab",section:"A",class_type:"Lab",duration:2,allowed_rooms:["R3","R5"],allowed_days:[1,3,5],forbidden_periods:[7,8]},
          {id:"A_English_Lab",faculty:"F4",subject:"English Lab",section:"A",class_type:"Lab",duration:2,allowed_rooms:["R3","R5"],allowed_days:[2,4,6],forbidden_periods:[7,8]},
              ...
              {days.map((day,di)=>(
                <tr key={di}>
                  ...
                  {periods.map(p=>{
                    ...
                    return (
                      <td key={p} style={{border:'1px solid #555', padding:10, minWidth:120, background: cls ? (cls.subject.toLowerCase().includes('lab') ? '#d1e7dd' : '#fff'):'#f8d7da'}}>
                        {cls ? (
                          <div>
